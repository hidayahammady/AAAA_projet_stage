...
<body class="min-h-screen bg-gradient-to-br from-purple-100 to-blue-100 p-6">
     <!-- Header -->
     <header class="bg-gray-800 py-5 px-8 flex items-center justify-center shadow-md sticky top-0 z-50">
    ...
    <footer class="bg-gray-800 text-white text-center py-4 mt-10">
        <p>&copy; <?php echo date('Y'); ?> Itqan. Tous droits réservés.</p>
    </footer>
